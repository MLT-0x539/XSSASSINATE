...
<html>
 ...
 <head>
   <title>XSSASSINATE | Precisely Inc. | XSS Weaponization Tool</title>
   <meta charset="utf-8">
   <meta name="description" content="An automated XSS weaponization and payload generation tool" />
   <meta name="keywords" content="XSS, Pentesting, Hacking, Cybersecurity, Payload, Payload generator, payload generation, weaponized, weaponize, javascript, PoC" />
   <meta name="author" content="Precisely, Inc." />
   <meta name="viewport" content="width=device-width, initial-scale=1.0">
   <link href="\styles\main.css" rel="stylesheet" />
   <script src="\scripts\prism.js"></script>
   <script> Prism.highlightAll(); console.log('mounted,', Prism, Prism.languages.flow); </script>
   <style> #myDIV { width: 100%; padding: 50px 0; text-align: center; background-color: lightblue; margin-top: 20px; }    </style>
 </head>
 ...
 <form action="#">
  <center>
    <br />
     <div id="outputz">
     <p><u>test:</u></p>
	 <textarea name="payloadURL" cols="40" rows="10">PATH TO WORDLIST HERE</textarea>
    <br />
